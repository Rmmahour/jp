...
<section class="service_top_tabs">
    <div class="container">
        <div class="nav_inner">
            <nav class="navigation service_list" id="mainNav">
    			<a class="navigation__link" href="#overview">Overview</a>
    			<a class="navigation__link" href="#service_dr">Doctors</a>
    			<a class="navigation__link" href="#testimonials">Testimonials</a>
    			<a class="navigation__link" href="#health_blogs">Health Blogs</a>
            </nav>
        </div>
    </div>
</section>
...
<section class="service_page">
    ...
    <div class="doc_single_data">
        ...
        <div class="service-tab" id="overview">
            <div class="service_overview p_100">
                <div class="container">
                            <div class="speciality_tabs_grid">
                                <div class="left">
                                    <div class="details_content">
                                        <div class="img_box">
                                            <img src="./assets/images/MRI-machine.webp" alt="">
                                        </div>
                                        <p>
                                ...
                                <div class="right">
                                    <div class="get_care_container">
                                        <div class="care_heading">
        ...
        <div class="service-tab" id="service_dr">
            <div class="service_dr p_100">
                <div class="container">
                            ...
                            <div class="doctor_box">
                                <a href="#">
                                        <div class="doctor_img">
                                            <img src="assets/images/doctors/Dr-Manoj-Luthra-1.webp" />
                                        </div>
                                <div class="doctor-content">
                                    ...
                                    <a href="#" class="profile_btn">
                                        ...
                                        <path
                                            ...
                                            fill="blue" stroke="blue" stroke-width="1.4" />
                                    </svg>
        ...
        <div class="service-tab" id="testimonials">
            <div class="service_testimonial p_100">
                <div class="container">
                    <div class="main_heading">
                    <h2>Testimonials</h2>
                    </div>
                    <div class="dr_blogs">
                        ...
                        <div class="owl-carousel doctor_blog_container owl-theme">


                            <div class="video_box">
                                <div class="inner_story_box doctor-box blog-box">
                                    <button class="play_button">
                                        <img src="assets/images/play-btn.png">
                                    </button>
                                    <video class="inner_story_video" loop muted controls>
                                        <source src="https://www.youtube.com/embed/K4TOrB7at0Y?si=Lxok0zfngVbfKeFq">
                                    </video>
                                    <img class="inner_story_img" src="assets/images/dr-bites.png" alt="Company Image">
                                </div>
        ...
        <div class="service-tab" id="health_blogs">
            <div class="service_blogs p_100">
                <div class="container">
                    <div class="main_heading">
                        <h2>Health Blogs</h2>
                    </div>
                    <div class="owl-carousel doctor_blog_container owl-theme">
                            ...
                            <div class="insight_img">
                                <img src="assets/images/blogs/Blog-1.webp" alt="insight1">
                            </div>
                            <div class="insight_content">
                                <p>
                                   Skin Cancer: A Growing Concern
                                </p>
                                <a href="#" class="know_more_btn">
                                    Know More
                                </a>
                            </div>
                        </div>
                        <div class="insight_box">
                            <div class="insight_img">
                                <img src="assets/images/blogs/Blog-2.webp" alt="insight1">
                            </div>
                            <div class="insight_content">
                                <p>
                        ...
                        <div class="insight_box">
                            <div class="insight_img">
                                <img src="assets/images/blogs/Understanding Blood Cancer All You Should Know-1.webp" alt="insight1">
                            </div>
                            <div class="insight_content">
                                <p>
...
<!-- 
    ...
    <section class="service_overview p_100">
    ...
    <section class="service_dr p_100">
                                    ...
                                    <span>
                                        <svg width="21" height="24" viewBox="0 0 21 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#065BAA" stroke="#065BAA" stroke-width="0.4" />
                                        </svg>
                                    </span>
                                    View Profile
                                </a>
    ...
    <section class="service_testimonial p_100">
        <div class="container">
            <div class="dr_blogs">
                ...
                <div class="owl-carousel doctor_blog_container owl-theme">
                    ...
                    <div class="inner_story_box doctor-box">
                        <button class="play_button">
                            <img src="assets/images/play-btn.png">
                        </button>
                        <img class="inner_story_img" src="assets/images/dr-bites.png" alt="Company Image">
    ...
    <section class="service_blogs p_100">
        <div class="container">
            <div class="dr_blogs">
                <h2>Doctor’s Blogs</h2>
