...
<main>
    ...
    <section class="speciality_top_tabs">
        <div class="container">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Mission-tab" data-bs-toggle="pill" data-bs-target="#pills-Mission" type="button" role="tab" aria-controls="pills-Mission" aria-selected="false">Mission & Vision</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Message-tab" data-bs-toggle="pill" data-bs-target="#pills-Message" type="button" role="tab" aria-controls="pills-Message" aria-selected="false">Chairman's Message</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Why-tab" data-bs-toggle="pill" data-bs-target="#pills-Why" type="button" role="tab" aria-controls="pills-Why" aria-selected="false">Why Jaypee Hospital</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Infrastructure-tab" data-bs-toggle="pill" data-bs-target="#pills-Infrastructure" type="button" role="tab" aria-controls="pills-Infrastructure" aria-selected="false">Infrastructure & Technology</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Brochure-tab" data-bs-toggle="pill" data-bs-target="#pills-Brochure" type="button" role="tab" aria-controls="pills-Brochure" aria-selected="false">Download Brochure</button>
                </li>
            </ul>
        </div>
    </section>
    ...
    <section class="speciality_tabs_content">
        <div class="container">
            <div class="tab-content p_100" id="pills-tabContent">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="Overview_box">
                                    <img src="assets/images/Patient centric high quality care.webp">
                ...
                <div class="tab-pane fade" id="pills-Mission" role="tabpanel" aria-labelledby="pills-Mission-tab" tabindex="0">
                    <div class="about_container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="core-values_conteiner">
                                    <h3>
                                        Core Values
                                    </h3>
                                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="chairman_img">
                                    <img src="assets/images/chairman.webp">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="sign_box">
                ...
                <div class="tab-pane fade" id="pills-Why" role="tabpanel" aria-labelledby="pills-Why-tab" tabindex="0">
                    <div class="sub_heading">
                        <h3>
                            Why Jaypee Hospital
                        </h3>
                ...
                <div class="tab-pane fade" id="pills-Infrastructure" role="tabpanel" aria-labelledby="pills-Infrastructure-tab" tabindex="0">
                    <div class="sub_heading">
                        <h3>
                ...
                <div class="tab-pane fade" id="pills-Brochure" role="tabpanel" aria-labelledby="pills-Brochure-tab" tabindex="0">
                    <div class="sub_heading">
                        <h3>
                            Download Brochure
                        </h3>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a href="https://www.jaypeehealthcare.com/sites/default/files/CorporateBrochure.pdf" target="_blank">
                                    <img src="assets/images/CorporateBrochure.webp">
...
<script>
    ...
    if (tab) {
        ...
        if (targetTab && targetPane) {
            // Deactivate the current active tab and pane
