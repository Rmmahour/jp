...
<section class="bread_sec inner find_dr">
    <div class="container">
            ...
            <div class="filter_grid">
                <div class="filter_box">
                    <div class="filter_drop">
                        <select class="form-select" id="filter_speciality" aria-label="Default select example">
                ...
                <div class="filter_box">
                    ...
                    <div id="main">
                        <input placeholder="Search by Name oe Speciality" type="text" name="text" class="input" />
                    ...
                    <!--        <input id="search_field" type="text" class="form-control" aria-label="Search by Name input" placeholder="Search by Name">-->
                    <!--        <button class="input-group-text bg-primary" id="inputGroup-sizing-default">-->
                    <!--            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">-->
...
<section class="doctors_sec p_100">
    <div class="container">
                        ...
                        <a href="#" class="profile_btn">
                            <svg width="36" height="26" viewBox="0 0 36 26" fill="none"
                                ...
                                <path
                                    ...
                                    fill="var(--blue)" stroke="var(--blue)" stroke-width="1.4" />
                            </svg>
