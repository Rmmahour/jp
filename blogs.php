                    ...
                    <div>
                        <form class="search_box">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" aria-label="Search by Blog" placeholder="Search All Blogs">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="main_blog">
                <div class="row">
                    <div class="col-md-7">
                        <div class="blog_img">
                            <img src="assets/images/blogs/Blog.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-5">
            ...
            <div class="p_100 other_blogs">
                <div class="other_blogs_container">
                        
                        <div class="blogs_box">
                            <div class="blogs_img">
                                <img src="assets/images/blogs/Blog-1.webp" alt="">
                            </div>
                            <div class="blogs_content_box">
                                <div class="date">
                                    <p>
                                         Mar 01, 2024
                                    </p>
                        ...
                        <div class="blogs_box">
                            <div class="blogs_img">
                                <img src="assets/images/blogs/Blog-2.webp" alt="">
                            </div>
                            <div class="blogs_content_box">
                                <div class="date">
                                    <p>
                        ...
                        <div class="blogs_box">
                            <div class="blogs_img">
                                <img src="assets/images/blogs/Understanding Blood Cancer All You Should Know-1.webp" alt="">
                            </div>
                            <div class="blogs_content_box">
                                <div class="date">
                                    <p>
...
//     $(function () {
//     let x = 6;
//     const items = $('.other_blogs_container > div');
...
//             items.filter(':hidden').slice(0, 6).slideDown();
//             x += 3;
...
// });
    ...
    $(function () {
        let x = 3;
        $('.other_blogs_container > div').slice(0, 3).show();
        $('.load_btn').on('click', function (e) {
            e.preventDefault();
            $('.other_blogs_container > div:hidden').slice(0, 3).slideDown();
        });
    });
    </script>
