...
<section class="single_doctor_bread">
    <div class="container">
        <div class="doctor_bread">
            <div class="bread_img">
                <div class="doc_img">
                    <img src="assets/images/doctors/Dr-Manoj-Luthra-1.webp" alt="Doctor">
                </div>
            </div>
...
<section class="doc_page_tabs">
    <div class="container">
        <div class="nav_inner">
            <nav class="navigation doc_tabs_list" id="mainNav">
    			<a class="navigation__link" href="#profile">About Us</a>
    			<a class="navigation__link" href="#opd">OPD Timing</a>
    			<a class="navigation__link" href="#dr_bites">Doctor Bites</a>
    			<a class="navigation__link" href="#dr_blogs">Doctor Blogs</a>
				<a class="navigation__link" href="#dr_appointment">Book an Appointment</a>
            </nav>
        </div>
    </div>
</section>
...
<section class="dr_summary trdd p_100">
    <div class="container">
        <div class="doctor_profile">
            <div class="doc_single_data">
                <div class="page-section doctors-tab listings" id="profile">
                    <div class="profile">
                        <div class="about_dr">
                            <p>
                ...
                <div class="page-section doctors-tab listings" id="opd">
                    <div class="dr_opd">
                ...
                <div class="page-section doctors-tab listings" id="dr_bites">
                    <div class="dr_bites">
                        <div class="main_heading">
                            <h2>Doctor’s Bites</h2>
                        </div>                    
                            <div class="owl-carousel doctor-bite-container owl-theme">
                ...
                <div class="page-section doctors-tab listings" id="dr_blogs">
                    <div class="dr_blogs">
                        <div class="main_heading">
                ...
                <div class="page-section doctors-tab listings" id="dr_appointment">
                    <div class="dr_appointment">
                        <div class="main_heading">
                        ...
                        <div class="contact_forms">
                            <div class="contact_right">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="contact_input">
                                            <select class="form-select" aria-label="Default select Surgery">
...
<div class="modal fade" id="singleDoctorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
        <div class="modal-body single_dr_video">
