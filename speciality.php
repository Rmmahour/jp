...
<main>
    ...
    <section class="speciality_top_tabs">
        <div class="container">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-doctors-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-doctors" type="button" role="tab" aria-controls="pills-doctors"
                        aria-selected="false">Doctors</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-speak-tab" data-bs-toggle="pill" data-bs-target="#pills-speak"
    ...
    <section class="speciality_tabs_content">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab"
                tabindex="0">
                <div class="container">
                    <div class="speciality_tabs_grid p_100">
                        <div class="left">
            ...
            <div class="tab-pane fade p_100" id="pills-speak" role="tabpanel" aria-labelledby="pills-speak-tab" tabindex="0">

                <div class="container">
                    <div class="patient_speak_grid">
    ...
    <div class="modal fade" id="specialityModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-body speciality_video">
