...
<section class="p_100">
    <div class="container">
        <div class="accordion" id="bmwAccordion">
          ...
          <div id="collapse22" class="accordion-collapse collapse show" aria-labelledby="heading22" data-bs-parent="#bmwAccordion">
            <div class="accordion-body">
                
                <div class="bmw_report_box">
                <div class="bmw_report">
                  <div class="bmw_sr">Sr. No.</div>
                  <div class="bmw_title">Title</div>
                  <div class="bmw_icon">Download</div>
                </div>
                <div class="bmw_report">
                  <div class="bmw_sr">
                    1
                  ...
                  <div class="bmw_icon">
                    <a class="download_pdf_icon" href="#"></a>
                  </div>
                </div>
        ...
        <div class="accordion-item">
          ...
          <div id="collapse21" class="accordion-collapse collapse" aria-labelledby="heading21" data-bs-parent="#bmwAccordion">
            <div class="accordion-body">
        ...
        <div class="accordion-item">
          ...
          <div id="collapse20" class="accordion-collapse collapse" aria-labelledby="heading20" data-bs-parent="#bmwAccordion">
            <div class="accordion-body">
        ...
        <div class="accordion-item">
          ...
          <div id="collapse19" class="accordion-collapse collapse" aria-labelledby="heading19" data-bs-parent="#bmwAccordion">
            <div class="accordion-body">
